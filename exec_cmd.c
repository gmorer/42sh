...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/09 15:15:30 by gmorer            #+#    #+#             */
<<<<<<< HEAD
/*   Updated: 2017/03/08 18:17:22 by acottier         ###   ########.fr       */
=======
/*   Updated: 2017/03/08 18:19:26 by gmorer           ###   ########.fr       */
>>>>>>> dba5637c4d06583b03075ecac2bfb398d10788be
/*                                                                            */
/* ************************************************************************** */
...
int				prep_exec(t_node *tree, char **env)
{
	...
	status = 0;
	current_job = (tree->fg ? (t_job*)malloc(sizeof(t_job)) : NULL);
	if (current_job)
